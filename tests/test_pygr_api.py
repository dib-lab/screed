...
from sqeaqr_pygr_api import SqeaqrSequenceDB, SqeaqrSequenceDB_ByIndex
...
def test_name_iterator_methods():
    db = SqeaqrSequenceDB(tests.testfa)
...
def test_index_iterator_methods():
    db = SqeaqrSequenceDB_ByIndex(tests.testfa)
...
def test_name_index_equality():
    db1 = SqeaqrSequenceDB(tests.testfa)
    db2 = SqeaqrSequenceDB_ByIndex(tests.testfa)
...
def test_seqinfodict_by_index():
    db1 = SqeaqrSequenceDB_ByIndex(tests.testfa)
    sd = db1.seqInfoDict
